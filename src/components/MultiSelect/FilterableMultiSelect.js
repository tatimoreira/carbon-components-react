...
export default class FilterableMultiSelect extends React.Component {
  ...
  handleOnChangeSubOptions = checkedItem => {
...
>>>>>>> 942cbdc12e8d51a0cee09681f8d2771a8b871ffa
  handleOnToggleMenu = () => {
    this.setState(state => ({
      isOpen: !state.isOpen,
    }));
      ...
      <Selection
        ...
        render={({ selectedItems, onItemChange, clearSelection }) => (
          <Downshift
            ...
            onChange={e => {
              if (e.options == undefined) onItemChange(e);
              this.handleOnChangeSubOptions(e);
            }}
